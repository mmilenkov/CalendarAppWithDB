...
public class EditEventServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Event event = new Event(Integer.valueOf(sDate[0]),(Integer.valueOf(sDate[1])-1),Integer.valueOf(sDate[2]),
        ...
        if(AbstractionChoice.DB_SAVE_METHOD.equals("jdbc")) {
            ...
            EventHolderJPA.editEvent(event, Integer.valueOf(req.getParameter("eventID")));
        }
